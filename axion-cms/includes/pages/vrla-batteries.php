    ...
    'sections' => [
        ...
        'hero' => [
            ...
            'fields' => [
                ...
                ['name' => 'subtitle', 'label' => 'Subtitle / Description', 'type' => 'textarea', 'rows' => 4,
                    'default' => 'Axion Critical Power Solutions provides high-performance, low-maintenance VRLA (Valve-Regulated Lead-Acid) batteries for mission-critical applications.'],
                ...
                [
                    'name' => 'applications', 'label' => 'Application Tags', 'type' => 'repeater',
                    'description' => 'Application tags shown in the hero',
                    'sub_fields' => [
                        ['name' => 'text', 'label' => 'Text', 'type' => 'text'],
                    ],
                ],
        ...
        'about' => [
            ...
            'fields' => [
                ...
                ['name' => 'label_text', 'label' => 'Label Text', 'type' => 'text',
                    'default' => 'VRLA (Valve-Regulated Lead-Acid) Batteries'],
                ['name' => 'description', 'label' => 'Description', 'type' => 'textarea', 'rows' => 5,
                    'default' => 'VRLA batteries are sealed, maintenance-free solutions ideal for mission-critical power systems. Axion Critical Power Solutions offers VRLA batteries designed to deliver high performance, long service life, and reliable operation in UPS, DC power plants, and standby applications.'],
                // ── ⬆ Section Stacking ──
        ...
        'why-choose' => [
            ...
            'fields' => [
                ...
                ['name' => 'heading_line3',      'label' => 'Heading Line 3',             'type' => 'text', 'default' => 'VRLA Batteries'],
                [
