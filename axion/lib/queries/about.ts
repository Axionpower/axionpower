  ...
  try {
    ...
    if (ax && (ax.heading || ax.label_text)) {
      return mergeWithDefaults({
        sectionBgColor: ax.section_bg_color,
        labelText: ax.label_text,
        labelColor: ax.label_color,
        labelBarColor: ax.label_bar_color,
        labelFontSize: ax.label_font_size ? parseInt(ax.label_font_size, 10) : undefined,
        headingText: ax.heading,
        headingColor: ax.heading_color,
        headingFontSize: ax.heading_font_size_desktop ? parseInt(ax.heading_font_size_desktop, 10) : undefined,
        headingFontSizeMobile: ax.heading_font_size_mobile ? parseInt(ax.heading_font_size_mobile, 10) : undefined,
        description1: ax.description_left,
        description2: ax.description_right,
        descriptionColor: ax.description_color,
        descriptionFontSize: ax.description_font_size ? parseInt(ax.description_font_size, 10) : undefined,
        button: {
          ...ABOUT_DEFAULTS.button,
          label: ax.button_text || ABOUT_DEFAULTS.button.label,
          url: ax.button_link || ABOUT_DEFAULTS.button.url,
          bgColor: ax.button_bg_color || ABOUT_DEFAULTS.button.bgColor,
          textColor: ax.button_text_color || ABOUT_DEFAULTS.button.textColor,
          fontSize: ax.button_font_size ? parseInt(ax.button_font_size, 10) : ABOUT_DEFAULTS.button.fontSize,
          borderRadius: ax.button_border_radius ? parseInt(ax.button_border_radius, 10) : ABOUT_DEFAULTS.button.borderRadius,
        },
        approachTitle: ax.approach_title,
        approachTitleColor: ax.approach_title_color,
        approachTitleFontSize: ax.approach_title_font_size ? parseInt(ax.approach_title_font_size, 10) : undefined,
        tagTextColor: ax.tag_text_color,
        tagBorderColor: ax.tag_border_color,
        tagFontSize: ax.tag_font_size ? parseInt(ax.tag_font_size, 10) : undefined,
        approachTags: Array.isArray(ax.approach_tags) ? ax.approach_tags.map((t: { tag: string }) => ({ tagText: t.tag })) : undefined,
        statValueColor: ax.stat_value_color,
        statValueFontSize: ax.stat_value_font_size ? parseInt(ax.stat_value_font_size, 10) : undefined,
        statDescColor: ax.stat_desc_color,
        statDescFontSize: ax.stat_desc_font_size ? parseInt(ax.stat_desc_font_size, 10) : undefined,
        statDividerColor: ax.stat_divider_color,
